...
![lifestyle_5_1995_model and youtube showing the difference of other model](lifestyle_5_1995_model_later.JPG) 
...
ok, job almost done and more easy to include IR receiver, directly fed the output to 68HC05C12, pin 37 (TCAP named). 68HC05C12 and VFD-driver-IC is underneath the VFD, barely to seen with some angle. Next to audio output area, there is RR101, metal shield like the tuner does, RR101 used a Xtal 26.690 MHz, perhaps the remote control was not that 27MHZ. ok go for IR, RF was the way too hard for me at the moment. Further on PCB tracing, the U106 (BA10393F), pin 1 output the control signal, goes throught wire cable J9B-J9A (pin9) to reach 68HC05C12, and at the same path, there is connection to Q406, clearly that no component installed for Q406 at the moment, and we bet 100% that for IR module.  
